...
Identify the dimensions of the `nba.shot` data frame -- how many shows does it refer to, and how many variables are collected for each show? 
...
Make a histogram to identify the center, shape, and spread of the `SHOT_DIST` variable. 
...
The above command extracts the 12 shooters who took the most shots in the 15-16 season. Facet the histogram you made in Question 5 by `playerName`. *Hint*: You can do this by adding `+ facet_wrap(~playerName)` to your code in Question 5. 
